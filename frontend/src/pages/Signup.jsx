...
import { Lock, Mail, User, ArrowRight, Activity, ShieldCheck } from 'lucide-react';
...
const Signup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Simulate API call
    setTimeout(() => {
      login({ name: formData.name, email: formData.email }); // Simulate user data
      setIsLoading(false);
      navigate('/predict');
    }, 1500);
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-cyan-500/5 rounded-full blur-3xl animate-pulse-slow" />
      ...
      >
        <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400">Join our secure healthcare network</p>
          </div>
